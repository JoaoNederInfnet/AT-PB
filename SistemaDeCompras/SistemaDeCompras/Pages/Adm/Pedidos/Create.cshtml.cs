...
public class Create : PageModel
{
    ...
    private readonly IAdmPedidosServices _admPedidosServices; //readonly para definir esse campo apenas no construtor
    //--------------------------------------------/------------------------------------------
    ...
    public Create(IAdmPedidosServices admPedidosServices)
    {
